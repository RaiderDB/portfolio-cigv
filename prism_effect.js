...
const fragmentShaderSource = `
    ...
    void main() {
        ...
        // Vignette unnecessary for transparent bg object usually
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Ensure we are operating in the distortion container context
    ...
    // Track mouse relative to canvas/container for correct local interaction OR window if desired.
    // The shader expects normalized 0-1.
    // Using window tracking as per original script for fuller effect feel
    ...
    function render() {
        ...
        gl.clearColor(0.0, 0.0, 0.0, 0.0); // Transparent background to blend? Or keep black? The shader outputs alpha 1.0 always.
        // But shader has its own background drawing.
